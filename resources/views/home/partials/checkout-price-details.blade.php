...
<div id="cart-summary"
    class="border border-gray-300 p-6 sticky top-24 bg-white shadow-lg h-fit font-[Inter] text-black"
    style="min-height: 320px; display: flex; flex-direction: column;">

    <h2 class="text-lg font-medium text-black mb-4 flex items-center">
    ...
    <div class="max-h-[300px] overflow-y-auto space-y-4 flex-grow pr-2 custom-scrollbar">
        ...
        @if($cartRooms->count() || $cartBoats->count())
                ...
                <div class="bg-gray-50 p-4 shadow-sm transition duration-200 hover:shadow-md">
                    ...
                    <div class="grid grid-cols-2 gap-y-1 text-sm text-black border-t pt-2 mt-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-black mr-1" fill="none"
                    ...
                    <div class="grid grid-cols-2 gap-y-1 text-sm text-black border-t pt-2 mt-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 432 480"
                                class="h-4 w-4 mr-1 text-black fill-current inline">
                                <path
            ...
            <a href="/home/roomcart"
                class="text-sm  text-[#964B00] hover:text-[#7a3c00] transition duration-150 flex items-center justify-center mt-3 pt-1">
        ...
        @else
            <div class="flex items-center justify-center min-h-[120px] bg-gray-50 border border-dashed border-gray-300">
                <p class="text-sm text-black text-center w-full p-4">Your cart is empty. Start planning your trip!</p>
            </div>
        @endif
    ...
    <div class="mt-6 pt-4 border-t border-gray-200">
        ...
        @else
            <button
                class="w-full bg-gray-300 text-black mt-5 py-3 font-medium cursor-not-allowed  "
                disabled>
                Checkout
            </button>
        @endif
