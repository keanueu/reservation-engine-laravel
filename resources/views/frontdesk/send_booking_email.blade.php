...
<div class="p-4 sm:p-6 space-y-6">
    ...
    <form action="{{ url('booking_email', $booking->id) }}" method="POST">
        @csrf
        {{-- Form Container --}}
        <div class="bg-white dark:bg-gray-800 p-6  shadow-lg space-y-6">
            ...
            <div class="pt-4 flex justify-end gap-3">
                <a href="{{ url()->previous() }}"
                   class="inline-flex items-center justify-center px-4 py-2.5 bg-white text-gray-700 text-sm font-medium border border-gray-300  hover:bg-gray-50 transition duration-150 ease-in-out shadow-sm dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">
                    Cancel
                </a>
                ...
                <button type="submit"
                    ...
                    <svg class="h-4 w-4 mr-1.5 -ml-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M3.105 3.105a1 1 0 011.414 0L10 8.586l5.48-5.481a1 1 0 111.415 1.414L11.414 10l5.481 5.48a1 1 0 11-1.414 1.415L10 11.414l-5.48 5.481a1 1 0 11-1.415-1.414L8.586 10 3.105 4.519a1 1 0 010-1.414z" clip-rule="evenodd" fill-rule="evenodd" d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
