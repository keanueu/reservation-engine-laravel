<div>
    <div class="max-w-xl text-sm text-black mb-6">
    ...
    <div>
        <button type="button" onclick="document.getElementById('delete-account-modal').classList.remove('hidden')"
                class="px-6 py-3 text-sm font-medium  bg-red-600 text-white hover:bg-red-700 transition-colors">
            Delete account
        </button>
    </div>
            ...
            <div class="inline-block align-bottom bg-white text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form method="POST" action="{{ route('current-user.destroy') }}">
                    ...
                    <div class="bg-white px-6 pt-6 pb-4">
                        <h3 class="text-lg text-black mb-4">Delete account</h3>
                        ...
                        <div class="mb-4">
                            <label for="delete_password" class="block text-sm font-medium  text-black mb-2">Password</label>
