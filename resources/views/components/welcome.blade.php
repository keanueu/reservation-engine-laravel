<div class="p-10 lg:p-12 bg-white border-b border-gray-100">
    ...
    <p class="text-gray-500 leading-relaxed max-w-3xl text-lg">
        Manage your resort operations with precision. From beachfront bookings to sail reservations, your central hub for hospitality excellence is now ready. Experience the perfect blend of tradition and modern management.
    </p>
</div>
