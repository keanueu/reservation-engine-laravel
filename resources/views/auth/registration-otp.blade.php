        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden group">
            ...
            <div class="absolute inset-0 branding-overlay flex flex-col justify-between p-12 text-white">
                ...
                <div class="max-w-md animate-fade-up" style="animation-delay: 0.2s">
                    <h2 class="text-5xl font-bold leading-tight mb-6">Verify your identity.</h2>
                    <p class="text-lg text-white/80 leading-relaxed">Safety first. Please enter the one-time password sent to your email.</p>
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-gray-50">
            <div class="w-full max-w-md animate-fade-up">
                <div class="bg-white p-10 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
                    <div class="relative">
                        <h2 class="text-3xl font-bold text-gray-900 mb-2">Account Verification</h2>
                        <p class="text-gray-500 text-sm mb-8">Enter the 6-digit code we sent to your email.</p>
                        ...
                        <form method="POST" action="{{ route('registration.otp.verify') }}" class="space-y-6">
                            @csrf
                            <div class="space-y-2">
                                <label for="code" class="text-sm font-semibold text-gray-700">OTP Code</label>
                                <div class="relative group">
                                    ...
                                    <input id="code" type="text" name="code" required autofocus maxlength="6"
                                        placeholder="123456"
                                        class="block w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-center text-2xl font-bold tracking-[0.5em] focus:bg-white focus:ring-4 focus:ring-[#964B00]/10 focus:border-[#964B00] outline-none transition-all duration-300">
                                </div>
                            </div>
                        ...
                        <div class="mt-8 text-center">
                            <form method="POST" action="{{ route('registration.otp.resend') }}">
                                ...
                                <p class="text-sm text-gray-600">
                                    ...
                                    <button type="submit" class="font-bold text-[#964B00] hover:text-[#7a3c00] transition-colors underline underline-offset-4">Resend OTP</button>
                                </p>
                            </form>
                        </div>
                    </div>
