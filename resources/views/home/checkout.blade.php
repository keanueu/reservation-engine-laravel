...
@section('content')
    <div class="relative w-full h-[35vh] md:h-[45vh]">
        ...
        <div class="relative z-10 flex items-end justify-center w-full h-full bg-black bg-opacity-50 px-4 pb-12 md:pb-16">
            <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl  text-white text-center ">
                Confirm Your Booking
            </h1>
        </div>
    </div>
    <div class="max-w-7xl mx-auto px-6 py-10">
        <div class="lg:hidden space-y-2 mb-8 "> <a href="{{ url('/home/roomcart') }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2 lg:order-1 space-y-10 ">
