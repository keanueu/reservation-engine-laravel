...
@section('content')
  ...
  <section data-animate
    class="bg-white py-16 opacity-0 will-change-transform will-change-opacity">
  ...
  <section data-animate
    class="bg-white py-2 opacity-0 will-change-transform will-change-opacity">
    <div class="max-w-7xl mx-auto px-6">
  ...
  <section data-animate class="bg-white py-8 opacity-0 will-change-transform will-change-opacity">
    <div class="max-w-7xl mx-auto px-6">
  ...
  <section data-animate class="bg-gray-50 py-8 opacity-0 will-change-transform will-change-opacity">
    <div class="max-w-7xl mx-auto px-6">
  ...
  <section data-animate class="bg-white py-8 opacity-0 will-change-transform will-change-opacity mb-12">
    <div class="max-w-7xl mx-auto px-6">
