...
function updateClock() {
    ...
    document.getElementById('current-time').textContent = new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true });
}
        ...
        const itemHTML = `
                                    <div class="forecast-item p-1 bg-white/50 dark:bg-gray-800/25 hover:bg-gray-100 dark:hover:bg-gray-700/20 transition rounded-md text-gray-900 dark:text-white flex justify-between items-center">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-xs font-normal text-gray-900 dark:text-white">${day}</p>
