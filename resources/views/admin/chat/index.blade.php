...
@section('content')
    ...
    <div class="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="lg:col-span-1 bg-white dark:bg-black  shadow-lg overflow-hidden h-full"
                style="max-height: 700px; display: flex; flex-direction: column;">
                <h2
                    class="text-lg font-semibold text-gray-800 dark:text-white p-5 sm:p-6 border-b border-gray-200 dark:border-black">
                    Active Sessions
                </h2>
            ...
            <!-- Chat Window -->
            <div class="lg:col-span-2 bg-white dark:bg-black  shadow-lg overflow-hidden"
                style="max-height: 700px; display: flex; flex-direction: column;">
                <div class="p-5 sm:p-6 border-b border-gray-200 dark:border-black">
                    <h2 id="chatHeader" class="text-lg font-semibold text-gray-800 dark:text-white">
                        Select a conversation
                    </h2>
                </div>

                <div id="chatWindow" class="flex-1 p-4 sm:p-6 overflow-y-auto bg-gray-50 dark:bg-black space-y-4">
                    <div class="flex justify-center items-center h-full">
                        <p class="text-gray-500 dark:text-gray-400">Please select a session to start chatting.</p>
                    </div>
                </div>

                <div class="p-4 sm:p-6 bg-white dark:bg-black border-t border-gray-200 dark:border-black">
                    <div class="flex space-x-0">
                        <input id="adminMsg"
                            class="flex-1 border border-gray-300 dark:border-black dark:bg-black dark:text-white rounded-l-md p-2 focus:ring-indigo-500 focus:border-indigo-500"
