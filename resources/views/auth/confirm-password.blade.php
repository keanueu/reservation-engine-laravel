		...
		<div class="w-full lg:w-1/2 bg-dark-bg text-white flex items-center justify-center p-6 sm:p-12">
			<div class="w-full max-w-lg">
				<div class="form-fade-in bg-white p-8  shadow-2xl">
					<h2 class="text-2xl sm:text-3xl text-black font-semibold mb-2">Confirm Password</h2>
					<p class="text-gray-700 text-sm mb-6">This is a secure area of the application. Please confirm your
						password
						before continuing.</p>
					@if ($errors->any())
					...
					<form method="POST" action="{{ route('password.confirm') }}">
						...
						<div class="mt-4">
							...
							<input id="password" type="password" name="password" required autocomplete="current-password"
								...
								class="block w-full px-4 py-3 text-sm bg-dark-input border border-gray-700  text-gray-700 placeholder-gray-500 focus:ring-[#964B00] focus:border-[#964B00] focus:outline-none transition duration-150" />
						</div>
						<div class="mt-8">
							<button type="submit"
								class="w-full text-sm bg-[#964B00] hover:bg-[#7a3c00] text-white font-semibold py-3  transition duration-300 shadow-lg shadow-orange-600/40">Confirm</button>
						</div>
					</form>
				</div>
			</div>
