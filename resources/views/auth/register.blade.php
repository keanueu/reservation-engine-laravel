...
@section('content')
    ...
    <div id="app" class="min-h-screen flex flex-col lg:flex-row bg-white">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden group">
            <img src="{{ asset('images/1759310456.jpg') }}" alt="Resort" class="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
            <div class="absolute inset-0 branding-overlay flex flex-col justify-between p-12 text-white">
                ...
                <div class="max-w-md animate-fade-up" style="animation-delay: 0.2s">
                    <h2 class="text-5xl font-bold leading-tight mb-6">Start your journey with us.</h2>
                    <p class="text-lg text-white/80 leading-relaxed">Join our community and enjoy exclusive offers and seamless bookings.</p>
                </div>
            ...
            <div class="w-full max-w-md animate-fade-up">
                <div class="bg-white p-10 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
                    <div class="relative">
                        ...
                        <p class="text-gray-500 text-sm mb-8">Join the Cabanas community today.</p>
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-5">
                            ...
                            <div class="grid grid-cols-1 gap-5">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div id="strength-text" class="text-xs mt-1 transition-all duration-300"></div>
                                </div>
                            ...
                            @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                                <div class="mt-4">
                                    <label class="relative flex items-center cursor-pointer group">
                                        ...
                                        <div class="ms-3 text-xs text-gray-600">
                                            {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                                'terms_of_service' => '<a target="_blank" href="' . route('terms.show') . '" class="underline font-bold text-[#964B00] hover:text-[#7a3c00]">' . __('Terms of Service') . '</a>',
                                                'privacy_policy' => '<a target="_blank" href="' . route('policy.show') . '" class="underline font-bold text-[#964B00] hover:text-[#7a3c00]">' . __('Privacy Policy') . '</a>',
                                            ]) !!}
                                        </div>
                                    </label>
                                </div>
                            ...
                            <button type="submit" class="w-full py-4 bg-[#964B00] hover:bg-[#7a3c00] text-white font-bold rounded-xl shadow-lg shadow-[#964B00]/20 transform transition-all duration-300 hover:-translate-y-1 active:scale-95 mt-4">
                                Create Account
                            </button>
